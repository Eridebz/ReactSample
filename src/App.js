...
import './App.css';
import image from '../src/Images/imgg.jpg'
...
// function App() {
//   const name= ['Ruth', 'Tope']
//   return (
//     <div className="App">
//       <h1 className='header'>Heading</h1>
//       <button className='button'>Click Me</button>
//       {}map, objects, filter, array
...
//   return (
//     <div>
//       <p> lorem lorem loremm lorem lorem lorem lorem</p>
  ...
  return(
    ...
    <div className='container'>
      <div className='img'>
        ...
        <div className='text'>
      <p>Lorem ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a gallery of type and srambled it to make a type and scrambles it to make a type speciment  </p>
      <h1>Skills</h1>
      <ul>
        <li>Moblie Developer</li>
